...
import 'package:task_management/common/libraries/src/common.dart';
...
class MonthSelectorState extends State<MonthSelector> {
  ...
  Widget _getMonthButton(final DateTime date, final String locale) {
    ...
    final isCurrent = widget.selectedDate == date;
    return ElevatedButton(
      ...
      child: Text(
        ...
        style: TextStyle(
          color: isEnabled ? Constant.primaryColor : Colors.grey,
          fontWeight: FontWeight.bold,
        ),
      ),
      style: ElevatedButton.styleFrom(
        backgroundColor:
            isCurrent ? Constant.primaryColor.withAlpha(25) : Colors.white,
