...
class Constant {
  ...
  static const String DOMAIN = "jsonplaceholder.typicode.com";
  static const String BASE_API_FULL = "https://${DOMAIN}";
  static const String APP_NAME = "Task Management";
  ...
  static const String kTaskList = "task_list";
